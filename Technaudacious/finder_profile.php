...
<body bgcolor = "#006793">
	...
	<table class = "form">
		...
		<tr>
			...
			<td>
				...
				<!-- For Sudarshaan: You don't need any JS function here. All you need to do is make this table as it is in PHP and then insert the finder name in it's place (using string concatenation). The formatting etc. should happen automatically. You won't need any functions for it.  -->
			</td>
		</tr>
		<tr>
			<td>
	...
	<table class = "second">
		...
		<tr>
			<td>
				Links which the finder has shared: 
			</td>
			<td>
				finderLinks
			</td>
		...
		<tr>
			<td>
				Media which the finder has shared: 
			</td>
			<td>
				finderMedia
			</td>
